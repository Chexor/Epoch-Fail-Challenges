...
- `f(n)` wordt vooral gebruikt in [[A-star Search]]
...
## 5. Toepassing
Als `g(n) = 7` en `h(n) = 3`, dan is `f(n) = 10`. Een algoritme zoals [[A-star Search]] vergelijkt dan nodes op basis van die totale score.
...
- **Link met andere concepten:** [[A-star Search]], [[g(n)]], [[h(n)]], [[Path Cost]], [[Heuristic]]