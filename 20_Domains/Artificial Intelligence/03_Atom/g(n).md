...
- centraal in [[Uniform-Cost Search (UCS)]] en [[A-star Search]]
...
- bij [[A-star Search]] vormt `g(n)` samen met [[h(n)]] de score [[f(n)]]
...
- **Link met andere concepten:** [[Path Cost]], [[Uniform-Cost Search (UCS)]], [[A-star Search]], [[h(n)]], [[f(n)]]