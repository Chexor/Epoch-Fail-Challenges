...
De gradient is een vector die in een functie met meerdere variabelen de richting van de snelste stijging aangeeft.

## Korte kern

- generaliseert de afgeleide naar meerdere variabelen
- wijst naar de snelste stijging
- de negatieve gradient wordt gebruikt voor daling
...
- [[Gradient]] = richting van snelste stijging in meerdere dimensies
- [[Derivative (Afgeleide)]] = helling in 1 dimensie
- [[Learning Rate]] = bepaalt hoe groot je stap langs die richting wordt
...
```python
gradient = [0.4, -1.2, 0.7]
next_direction = [-value for value in gradient]
```
...
- **Link met andere concepten:** [[Optimization and Training]], [[Derivative (Afgeleide)]], [[Gradient Descent]], [[Learning Rate]], [[Loss Function]]
