...
Path cost is de totale kost van een volledig of gedeeltelijk pad in een probleemruimte, gemeten volgens de kosten uit het probleem zelf.

## Korte kern

- path cost telt de kosten van gekozen stappen op
- het gaat over kost in het probleem, niet over rekentijd van het algoritme
- het begrip zit rechtstreeks achter [[g(n)]], [[Uniform-Cost Search (UCS)]] en [[A-star Search]]
...
- [[Path Cost]] = totale kost van een pad in het probleem
- [[g(n)]] = path cost tot de huidige node `n`
- [[h(n)]] = geschatte resterende kost, dus geen echte path cost
...
- **Link met andere concepten:** [[State Space]], [[Search Algorithm]], [[Uniform-Cost Search (UCS)]], [[A-star Search]], [[Heuristic]], [[Priority Queue]]
