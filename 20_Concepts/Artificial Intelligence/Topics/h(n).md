...
- centraal in [[Heuristiek]], [[Greedy Best-First Search]] en [[A-star Search|A* Search]]
...
- `h(n)` is de centrale score in [[Heuristiek]]
- bij [[Greedy Best-First Search]] bepaalt `h(n)` rechtstreeks de prioriteit
- bij [[A-star Search|A* Search]] wordt `h(n)` gecombineerd met [[g(n)]] tot [[f(n)]]
...
- **Link met andere concepten:** [[Heuristiek]], [[Greedy Best-First Search]], [[A-star Search|A* Search]], [[Admissible Heuristic]], [[Consistent Heuristic]], [[g(n)]], [[f(n)]]