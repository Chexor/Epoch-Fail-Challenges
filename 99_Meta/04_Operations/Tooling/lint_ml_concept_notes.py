...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Lint-check voor concept notes in 20_Domains/Machine Learning"
    )
    parser.add_argument(
        "--base-dir",
        default="20_Domains/Machine Learning",
        help="Pad naar de te controleren map (default: 20_Domains/Machine Learning)",
    )
    parser.add_argument(
        "--strict-theory",
        action="store_true",
