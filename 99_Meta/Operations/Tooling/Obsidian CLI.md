...
- target a file by vault-relative path: `obsidian read path="20_Wiki/Recipe.md"`

## File Operations

```bash
obsidian rename path="20_Wiki/Old Name.md" name="New Name"
obsidian move path="20_Wiki/Note.md" to="10_Modules/Module X/Notes/"
obsidian create path="20_Wiki/New Note.md" content="# New Note\n"
obsidian append path="20_Wiki/Note.md" content="\n- [ ] Follow up"
obsidian prepend path="20_Wiki/Note.md" content="- status: draft"
```
...
obsidian task ref="20_Wiki/Note.md:12" toggle
```
