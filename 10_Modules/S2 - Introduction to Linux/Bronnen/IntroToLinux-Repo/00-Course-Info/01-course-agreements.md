...
- 📄 **PDF Course Material** (Comprehensive reference)
- �� **PDF Slides** (Lecture presentations)
...
6. **🔍 Filters and Scripting**
   - Text processing
   - Shell scripting basics

7. **👥 Users, Groups, and Tools**
   - User management
...
- [ ] 📥 Downloaded Linux ISO image
- [ ] 🔧 Installed virtualization software (if needed)
- [ ] ✅ Tested your Linux installation
- [ ] 📱 Can access Toledo Ultra
- [ ] 📧 Know how to reach your lecturers
